...
// // 新增
// @PostMapping("/add")
// public ResponseEntity<String> postPlatformStaffService(@RequestBody
...
// psService.savePS(platformStaff.getId(), platformStaff.getName(),
// platformStaff.getRole(),
// platformStaff.getGender(), platformStaff.getBirthday(),
// platformStaff.getPhone(),
// platformStaff.getMobile_phone(), platformStaff.getAddress(),
// platformStaff.getEmail(),
// platformStaff.getPassword(), platformStaff.getCreatedAt(),
// platformStaff.getUpdatedAt(),
...
// // 更新 PlatformStaff
// @PutMapping("/{id}")
// public PlatformStaff updatePlatformStaff(@RequestBody PlatformStaff
// platformStaff) {
